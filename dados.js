const prova = {
  ...
  itens: [
    {
      capacidade:
        "Interpretar requisitos levantados para desenvolvimento de sistemas",
      contexto:
        ...
        "O foco da atividade foi interpretar os requisitos levantados e transformá-los em requisitos funcionais e não funcionais, visando modelar soluções coerentes e alinhadas com os objetivos do sistema.",
      pergunta: `
...
<table border="1" cellpadding="5" cellspacing="0" style="border-collapse: collapse; width: 100%;">
  ...
  <tbody>
    <tr>
      ...
      <td>Interpretar requisitos levantados para desenvolvimento de sistemas</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>2. Contribuição na discussão de implementação do sistema</td>
      <td>Identificar requisitos funcional e não funcional para desenvolvimento de sistemas</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>3. Geração de ideias e propostas de solução</td>
      <td>Aplicar linguagem de programação para modelagem dos requisitos do sistema</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>4. Desenvolvimento de protótipo inicial</td>
      <td>Reconhecer sistemas de interface para usuários (ux)</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>5. Clareza e organização das ideias apresentadas</td>
      <td>Identificar documentação técnica aplicada ao escopo do projeto</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>6. Construção de requisitos funcionais e não funcionais do sistema</td>
      <td>Reconhecer requisitos de qualidade, integridade, usabilidade e segurança da informação</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>7. Seleção de tecnologias apropriadas para o projeto</td>
      <td>Definir tecnologias de acordo com os requisitos não funcionais</td>
      <td></td><td></td><td></td><td></td>
    </tr>
    <tr>
      <td>8. Integração de soluções propostas</td>
      <td>Integrar sistemas orientados para a conectividade e interoperabilidade</td>
      <td></td><td></td><td></td><td></td>
    </tr>
  </tbody>
</table>
